...
# devtools::install_local("C:/Users/AhmadWaseem/Desktop/GSIF")
...
# require(devtools)
# install_version("GSIF", version = "0.5-5", repos = " http://R-Forge.R-project.org", type = "source")
...
# frs_FWTools.path <- function(...) { return(paste(root_path, "/FWTools/", sep="")) }
