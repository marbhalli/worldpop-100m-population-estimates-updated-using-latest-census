...
exec(open("C:/Users/AhmadWaseem/Desktop/bhalli/worldpop rf/src/01.0 - Configuration.py.r").read())
...
data_desc = arcpy.Describe(in_path)
input_prj = arcpy.Describe(in_path).SpatialReference.exportToString()
